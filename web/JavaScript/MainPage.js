...
//点击最新发布
document.querySelector('.title-time').addEventListener('click',function (event){
    document.querySelector('.active').classList.remove('active')
    document.querySelector('.title-time').classList.add('active')
    document.querySelector('.articles').innerHTML=''
    addTimeArticles()

})
//点击点赞最多
document.querySelector('.title-give').addEventListener('click',function (event){
    console.log('点击点赞最多')
    document.querySelector('.active').classList.remove('active')
    document.querySelector('.title-give').classList.add('active')
    document.querySelector('.articles').innerHTML=''
    axios.get('/Blog/Likes/MainPageGiveCountTest')
        .then(result => {
            addArticle(result)
        })
        .catch(error => {
...
//点击收藏最多
document.querySelector('.title-collect').addEventListener('click',function (event){
    console.log('点击点赞最多')
    document.querySelector('.active').classList.remove('active')
    document.querySelector('.title-collect').classList.add('active')
    document.querySelector('.articles').innerHTML=''
    axios.get('/Blog/CollectArticle/MainPageCollectArticleCountTest')
        .then(result => {
            addArticle(result)
        })
        .catch(error => {
...
//点击我的关注
document.querySelector('.title-follow').addEventListener('click',function (event){
    console.log('点击点赞最多')
    document.querySelector('.active').classList.remove('active')
    document.querySelector('.title-follow').classList.add('active')
    document.querySelector('.articles').innerHTML=''
    const user_id=localStorage.getItem('id')
    axios({
        url: '/Blog/Follows/MainPageFollowCountTest',
        method: 'get',
        params: {
            user_id
        }
